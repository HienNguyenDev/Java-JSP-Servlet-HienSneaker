            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                    ...
                    <div class="block-4-text p-4">
                        <h3><a href="#" class="text-black"><%= glasses.getName() %></a></h3>
                        <p class="mb-0"><%= glasses.getDescription() %></p>
                        <p class="text-danger font-weight-bold">$<%= glasses.getPrice() %></p>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <form action="MainController" method="POST">
                <li class="mb-1"><a href="SearchCategoriesController?category=Adidas" class="d-flex"><span>Adidas</span></a></li>
                <li class="mb-1"><a href="SearchCategoriesController?category=Nike" class="d-flex"><span>Nike</span> </a></li>
                <li class="mb-1"><a href="SearchCategoriesController?category=MLB" class="d-flex"><span>MLB</span></a></li>
