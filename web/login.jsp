          ...
          <div class="p-3 p-lg-5 border">
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <input type="text" placeholder="UserID/Email" class="form-control" id="c_username" name="userIDorEmail">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                <label for="c_password" class="text-black">Password <span class="text-danger">*</span></label>
                <input type="password" placeholder="Password" class="form-control" id="c_password" name="password">
              </div>
            </div>
                <% 
